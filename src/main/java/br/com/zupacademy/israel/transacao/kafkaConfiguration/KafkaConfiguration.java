package br.com.zupacademy.israel.transacao.kafkaConfiguration;

import br.com.zupacademy.israel.transacao.consumirTransacoes.TransacaoConsumer;
...
public class KafkaConfiguration {
    ...
    public ConsumerFactory<String, TransacaoConsumer> transactionConsumerFactory(){
        ...
        JsonDeserializer<TransacaoConsumer> jsonDeserializer = new
                JsonDeserializer<>(TransacaoConsumer.class, false);
